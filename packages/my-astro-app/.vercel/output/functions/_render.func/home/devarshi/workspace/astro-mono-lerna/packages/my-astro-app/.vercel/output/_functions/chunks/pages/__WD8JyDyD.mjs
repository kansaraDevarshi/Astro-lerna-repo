...
function AstroAuth(options = authConfig) {
  const { AUTH_SECRET, AUTH_TRUST_HOST, VERCEL, NODE_ENV } = Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": undefined, "ASSETS_PREFIX": undefined}, { AUTH_TRUST_HOST: true, AUTH_SECRET: process.env.AUTH_SECRET, _: process.env._, NODE: process.env.NODE, NODE_ENV: process.env.NODE_ENV });
